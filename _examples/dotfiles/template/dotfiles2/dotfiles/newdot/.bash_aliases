...
alias pscr='cd ~/pscr'
alias sd='cd /sdcard'
alias sdx='cd /storage/405A-7494
alias music='cd /sdcard/Music'
alias musicx='cd /storage/405A-7494/music'
...
# rights
alias chownall='sudo chown u0_a219:u0_a219'
alias chownallr='sudo chown -R u0_a219:u0_a219'
